...
def main():
    ...
    try:
        ...
        if missing_secrets:
            print(f"\n⚠️  WARNING: Missing required secrets for {plan.mode} mode:")
        ...
        if missing_telegram:
            print(f"\n💡 INFO: Optional Telegram settings not configured:")
        ...
        if changes:
            ...
            for key, old_value, new_value in changes:
                print(f"  {key}: {old_value or '<not set>'} → {new_value}")
        else:
        ...
        if not args.dry_run and args.write:
            print(f"\n✅ Applied plan '{plan.profile_name}' to {args.env}")
            print("\nNext steps:")
